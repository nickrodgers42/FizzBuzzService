...
buildscript {
    ...
    dependencies {
        ...
        classpath("software.amazon.smithy:smithy-openapi:1.28.0")
        classpath("software.amazon.smithy:smithy-aws-traits:1.28.0")
    }
}
...
dependencies {
    ...
    implementation("software.amazon.smithy:smithy-validation-model:1.28.0")
}
